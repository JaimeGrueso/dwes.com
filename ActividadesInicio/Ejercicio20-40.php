...
<body>
    ...
    <h3>24</h3>
    <p>
        24. Crear un script PHP asigna a variables un nombre del usuario y un número entero. 
        Luego muestre el nombre del usuario en tantas líneas como indique el número.
    </p>
    <?php
    $numero = rand(0, 10);
    $nombre = "pepe";
    ...
    <h3>26</h3>
    <p>
        Crea un script PHP que asigna a tres variables números enteros aleatorios y los muestra en orden ascendente. 
        Además mostrará también si la generación aleatoria fue en orden.
    </p>
    <?php
