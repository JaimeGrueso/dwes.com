...
if( $_SERVER['REQUEST_METHOD'] == "GET" ) { // 
    if( isset( $_COOKIE['color_fondo']) && isset($_COOKIE['color_texto'])) { // Comprobamos si las cookies estan establecidas
        ...
        if( ! array_key_exists($color_fondo, $colores_validos) || // Se comprueba si existen 
            ! array_key_exists($color_texto, $colores_validos) ) {
            $color_fondo = "white"; // se ponen por defecto
            $color_texto = "black";
        }
    }
    else {
